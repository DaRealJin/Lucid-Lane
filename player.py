#Playerentity:readscontrolsfromsettingsandmoveswithtilecollision
import pygame
...
class Player(Sprite):
    def __init__(self, image, x, y):
        ...
        #LetsplayerschooseWASDorarrowkeyswithoutchangingcode
    ...
    def move_with_collision(self, dx, dy, tilemap):
        #Axis-separatedmovementpreventsgettingstuckincorners
        self.rect.x += dx
